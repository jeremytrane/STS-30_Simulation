function []=draw_srb_left(x0,y0,z0,shuttle_angle,roll_angle,SRB_fuellevel,thrust_SRB)
% "draw_srb_left" draws the left SRB of Atlantis including the cylinder for
